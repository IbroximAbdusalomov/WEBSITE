countries = [
    ...
    {"name": "East Timor", "slug": "east-timor"},
    ...
    {"name": "United States of America", "slug": "united-states-of-america"},
...
#     Country.objects.create(name=country_data["name"], slug=country_data["slug"])
