...
SECRET_KEY = 'django-insecure-xff9odij3e#_s!ruwwuwc=9_m!cucd-atap((_lykp8a@)gvoh'
...
WSGI_APPLICATION = 'Technoprom.wsgi.application'
...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = 'ibrohimlololowka@gmail.com'
EMAIL_HOST_PASSWORD = 'kalygbyfpiyiphcg'
